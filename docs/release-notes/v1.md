...
Status: LocalQL distribution alias accepted for `v1.0.0`; full candidate proof
refresh needed
...
Current status is LocalQL distribution alias accepted for `v1.0.0`; full
candidate proof must be refreshed before any external release action.

The tracked proof packet is
[`docs/release-candidate-proof-2026-07-02.md`](../release-candidate-proof-2026-07-02.md).
It records a `release-candidate eligible` assessment for proof target
`538f024 docs: plan release candidate proof refresh` before the LocalQL
distribution alias was applied. The alias update changes wheel and sdist
artifact names, so full candidate proof must be refreshed on the LocalQL
candidate state.
