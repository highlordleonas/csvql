...
directly, `x` opens deterministic starter SQL templates, and `Ctrl+Space`
opens explicit SQL completion from loaded source metadata. Generated SQL is
inserted into the editor and does not run until the user explicitly runs it.
