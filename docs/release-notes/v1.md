...
candidate proof has been refreshed before external release action. Public docs
now keep the release proof procedure in [Release readiness](../release-readiness.md)
instead of tracking raw local proof packets in the public branch.
