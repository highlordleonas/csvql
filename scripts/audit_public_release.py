...
PUBLIC_SCRIPT_FILES: Final[frozenset[str]] = frozenset(
    {
        ...
        "scripts/benchmark_multiformat_exports.py",
...
PUBLIC_SOURCE_FILES: Final[frozenset[str]] = frozenset(
    {
        ...
        "src/csvql/export.py",
        "src/csvql/export_benchmark.py",
        "src/csvql/inspection.py",
        "src/csvql/json_adapter.py",
        "src/csvql/json_schema.py",
        "src/csvql/models.py",
...
PUBLIC_TEST_FILES: Final[frozenset[str]] = frozenset(
    {
        ...
        "tests/test_multiformat_export.py",
