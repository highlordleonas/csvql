...
class DiagnosticCode(StrEnum):
    ...
    SOURCE_JSON_INVALID = "source.json_invalid"
    SOURCE_NDJSON_INVALID = "source.ndjson_invalid"
    SOURCE_JSON_RECORD_SHAPE_INVALID = "source.json_record_shape_invalid"
    SOURCE_JSON_RECORD_PATH_INVALID = "source.json_record_path_invalid"
    SOURCE_JSON_RECORD_PATH_MISSING = "source.json_record_path_missing"
    SOURCE_JSON_RECORD_PATH_NOT_ARRAY = "source.json_record_path_not_array"
    SOURCE_JSON_RECORD_NOT_OBJECT = "source.json_record_not_object"
    SOURCE_JSON_SCHEMA_INVALID = "source.json_schema_invalid"
    SOURCE_JSON_SCHEMA_CAST_FAILED = "source.json_schema_cast_failed"
    SOURCE_JSON_DEPENDENCY_MISSING = "source.json_dependency_missing"
    SOURCE_EXCEL_INVALID = "source.excel_invalid"
    SOURCE_EXCEL_METADATA_LIMIT = "source.excel_metadata_limit"
    SOURCE_EXCEL_SHEET_MISSING = "source.excel_sheet_missing"
    SOURCE_EXCEL_SHEET_AMBIGUOUS = "source.excel_sheet_ambiguous"
    SOURCE_EXCEL_RANGE_INVALID = "source.excel_range_invalid"
    SOURCE_EXCEL_RANGE_REQUIRED = "source.excel_range_required"
    SOURCE_EXCEL_SCHEMA_INFERENCE_FAILED = "source.excel_schema_inference_failed"
